            ...
            success: function(data){
                ...
                data.results.forEach(function(pokemon){
                    ...
                    div_card_pkm.className = 'card mt-2 mb-2';
                        ...
                        var div_card_head = document.createElement('div');
                        div_card_head.className = 'card-header';
                        div_card_pkm.append(div_card_head);
